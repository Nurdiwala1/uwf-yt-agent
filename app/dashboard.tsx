...
export function Dashboard({ initialJobs, initialLogs, configured, youtubeConnected, channelStats, youtubeAnalytics }: { initialJobs: ContentJob[]; initialLogs: JobLog[]; configured: boolean; youtubeConnected: boolean; channelStats: YoutubeChannelStats | null; youtubeAnalytics: YoutubeAnalytics | null }) {
  ...
  <section className="panel"><p className="eyebrow">SCHEDULE RULE</p><h2>Weekly format</h2><p className="schedule"><b>Monday–Sunday</b><br/>Long-form videos only<br/><br/><b>Daily</b><br/>1 video · 5–10 minutes<br/><br/><span className="muted">Shorts are manual-only and are not generated or uploaded by the agent.</span></p></section></div></section></main>;
}
